...
if [ "$#" -lt 3 ]; then
  echo "Usage: $0 <parent_directory> <model_type> <mode> [--no-mask-model] [--sam2-segment] [--harmonize] [--crop_to_width <crop_to_width>] [--crop_to_height <crop_to_height>] [--target_width <target_width>] [--target_height <target_height>]"
